...
///
/// This allows pro! messages to make use of the environment efficiently
/// and user friendly while also maintaining access invariants.
#[derive(Copy, Clone)]
pub struct EnvAccess<'a, T> {
    /// Tricks the Rust compiler into thproing that we use `T`.
    ...
    T: Environment,
{
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::caller`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::transferred_balance`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::weight_to_fee`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::gas_left`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::block_timestamp`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::account_id`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::balance`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::rent_allowance`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::block_number`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::minimum_balance`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::tombstone_deposit`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::set_rent_allowance`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::invoke_contract`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::eval_contract`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::instantiate_contract`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::restore_contract`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::terminate_contract`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::transfer`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::random`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::hash_bytes`]
    ...
    /// # Note
    ///
    /// For more details visit: [`pro_env::hash_encoded`]
