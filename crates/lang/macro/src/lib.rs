...
pub fn test(attr: TokenStream, item: TokenStream) -> TokenStream {
    pro_test::generate(attr.into(), item.into()).into()
}
...
/// # }
/// ```
/// ... or as multiple stand alone pro! attributes applied to the same item:
/// ```
/// # type Access = i32;
/// # use pro_lang as pro;
/// # #[pro::chain_extension]
...
/// }
/// # #[derive(scale::Encode, scale::Decode, tetsy_scale_info::TypeInfo)]
...
/// as well as `tetsy-scale-info`'s `TypeInfo` trait.
///
