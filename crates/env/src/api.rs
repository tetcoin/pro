...
///   Prefer to use the pro! guided and type safe approach to using this.
///
/// # Errors
///
...
///
/// When using pro! users do not have to construct those enum dispatch types
/// themselves as they are normally generated by the pro! code generation
/// automatically.
///
/// # Errors
///
