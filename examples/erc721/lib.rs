...
//! ## Overview
//!
//! This contract demonstrates how to build non-fungible or unique tokens using pro!.
//!
//! ## Error Handling
//!
...
mod erc721 {
    ...
    mod tests {
        ...
        fn mint_existing_should_fail() {
            ...
            assert_eq!(1, pro_env::test::recorded_events().count());
            // Alice owns 1 token.
            assert_eq!(erc721.balance_of(accounts.alice), 1);
        ...
        fn transfer_works() {
            ...
            assert_eq!(2, pro_env::test::recorded_events().count());
            // Bob owns token 1
        ...
        fn approved_for_all_works() {
            ...
            pro_env::test::pop_execution_context();
